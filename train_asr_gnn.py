...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for (batch,) in train_loader:
            ...
            node_repr, edge_gate, l0_term = model.encode_graph(heads, rels, edge_index, edge_t>
            ...
            neg_scores = model.score_triples(node_repr, neg_triples).view(batch.size(0), args.>
        ...
        train_stats = {
            ...
            "sparse_loss": total_sparse / n_batches,
    ...
    checkpoint = torch.load(os.path.join(args.output_dir, "best_model.pt"), map_location=devic>
    ...
    save_json(os.path.join(args.output_dir, "valid_best.json"), best_metrics)
    save_json(os.path.join(args.output_dir, "metrics.json"), test_metrics)
